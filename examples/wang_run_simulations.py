...
from hanabi_learning_environment.agents.ref_mcts.wang.load_agents import load_agent
from hanabi_learning_environment.agents.ref_mcts.wang.wang_mcts import MCAgent
from hanabi_learning_environment.agents.ref_mcts.wang import experience as exp
...
if __name__ == "__main__":
    ...
    flags = {'players': 2,
             'num_episodes': 1,
             'agent_class': 'MCAgent',
             'agent2_class': "SimpleAgent",
             'debug': False,
             'agent_predicted': "SimpleAgent",
             'agent_predicted2': "",
             'model_class': "",
             'model_class2': "",
